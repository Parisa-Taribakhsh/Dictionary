...
function MyDictionary() {
    ...
    let wordsEditHandler = e => setOpenEditBox({
        isOpen: true,
        item: {key: openEditBox.item.key, word: e.target.value, definition: openEditBox.item.definition}
    })
    let definitionsEditHandler = e => setOpenEditBox({
        isOpen: true,
        item: {key: openEditBox.item.key, word: openEditBox.item.word, definition: e.target.value}
    })
    ...
    let editWord = () => {
        ...
        axios.put(`https://dictionary-d48c1-default-rtdb.firebaseio.com/words/${openEditBox.item.key}.json`, {
            ...
            .then(() => {
                setOpenEditBox({isOpen: false, item: {}})
            })
            .catch(() => {
            })
            .finally(() => {
            ...
            <div>
                ...
                <div className='container text-center p-1'>
                    <div className='row py-4'>
                        <div className='col-12 col-lg-5 my-2 m-align'>
                            <TextField
